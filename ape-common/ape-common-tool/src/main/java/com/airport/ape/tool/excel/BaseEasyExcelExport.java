package com.airport.ape.tool.excel;

import com.airport.ape.tool.SpringContextUtil;
...
public abstract class BaseEasyExcelExport<T> {
    ...
    /**
     * 导出到excel，支持大数量的分批写入,sheetDataRows整除writeDataRows
     */
    ...
    private void doExport(HttpServletResponse response, String fileName, Map<String, Object> queryCondition,
                          Integer totalCount, Integer sheetDataRows, Integer writeDataRows) {
        ...
        try {
            ...
            Integer oneSheetWriteCount = totalCount > sheetDataRows ? sheetDataRows / writeDataRows :
     ...
     * 计算导出数据的总数
     */
    protected abstract Integer dataTotalCount(Map<String, Object> conditions);
